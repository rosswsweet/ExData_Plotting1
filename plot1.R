...
# over a period of years. The data is filtered to two days and a histogram of household global 
# minute-averaged active power in kilowatts is printed to a png file.
...
# The histogram is produced and printed to the file plot1.png
png(file = "plot1.png", width = 480, height = 480)

hist(filtData$Global_active_power, col = "red", 
